...
-- Tabla intermedia para saber qué ingredientes lleva cada pizza y cuánto descuenta del stock
...
-- Tabla para permitir que un pedido tenga varias pizzas diferentes
